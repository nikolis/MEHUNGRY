defmodule MehungryServerWeb.CategoryController do
 ...
 def swagger_definitions do
    ...
    CategoryTranslation: swagger_schema do
      title "Category Transalation"
      description "Structs representing the translation of a category" 
      properties do
        name :string, "The name of the category translated in the language infered e.g grammar", required: true 
