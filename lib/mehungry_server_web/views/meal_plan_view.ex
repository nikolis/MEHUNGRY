defmodule MehungryServerWeb.MealPlanView do
  use MehungryServerWeb, :view
  alias MehungryServerWeb.MealPlanView
  alias MehungryServerWeb.DailyMealPlanView
  ...
  def render("meal_plan.json", %{meal_plan: meal_plan}) do
    %{id: meal_plan.id,
      ...
      daily_meail_plans: render_many(meal_plan.daily_meal_plans, DailyMealPlanView, "daily_meal_plan.json")
    }
  end
end
