defmodule MehungryServerWeb.RecipeView do
  use MehungryServerWeb, :view

  alias MehungryServerWeb.RecipeView
  alias MehungryServerWeb.RecipeIngredientView
  alias MehungryServerWeb.UserView
  alias MehungryServerWeb.StepView
  ...
  def render("recipe.json", %{recipe: recipe}) do
    %{id: recipe.id,
      ...
      recipe_ingredients: render_many(recipe.recipe_ingredients, RecipeIngredientView, "recipe_ingredient.json")
    }
  end
end
